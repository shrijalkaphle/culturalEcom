                    ...
                    <div class="card-body">
                        <form action="{{ route('categories.update',$category->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" required placeholder="Category Name" class="form-control" value="{{ $category->name }}">
                            </div>
                            <div class="form-group">
                                <label for="display">Display Name</label>
                                <input type="text" name="display" id="display" required placeholder="Category Display Name" class="form-control" value="{{ $category->display }}">
                            </div>
