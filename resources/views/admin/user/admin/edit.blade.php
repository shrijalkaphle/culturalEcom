                ...
                <div class="main-card mb-3 py-3 card card-body">
                    <form action="{{ route('admin.update',$user->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="number" id="number" required class="form-control" value="{{$user->number}}">
                            @error('number') <span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label for="dob">Date of Birth</label>
                                <input type="date" name="dob" id="dob" required class="form-control" value="{{$user->dob}}">
                            </div>
                            <div class="col-md-6">
                        ...
                        <center><button class="btn btn-primary w-50 my-4">Update</button></center>
                    </form>
                </div>
            </div>
        </div>
